package id.co.octolink.erd.ilm.ingenicoassetsmanagement.ui.out.scanstaff;
...
public class StaffOutScanActivity extends AppCompatActivity {
    private SessionManager sessionManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_out_scan);
