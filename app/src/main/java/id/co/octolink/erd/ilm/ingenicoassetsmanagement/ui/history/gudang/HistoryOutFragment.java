package id.co.octolink.erd.ilm.ingenicoassetsmanagement.ui.history.gudang;
 ...
 * Use the {@link HistoryOutFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HistoryOutFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    @BindView(R.id.recycler_history_out)RecyclerView recyclerViewHistoryOut;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_history_out, container, false);
        ...
        recyclerViewHistoryOut.setLayoutManager(linearLayoutManager);
        recyclerViewHistoryOut.setHasFixedSize(true);
    ...
    private void getHistoryStockOut() {

        ApiService apiService =
                RestApi.getClient().create(ApiService.class);

        Call<HistoryResponse> call = apiService.historyStockOut(staff_code);
        call.enqueue(new Callback<HistoryResponse>() {
            ...
            public void onResponse(Call<HistoryResponse>call, Response<HistoryResponse> response) {
                ...
                if (response.isSuccessful() && response.body().getStatus()) {
                    ...
                    mFirebaseAnalytics.logEvent("history_out", params);
...
//                            startActivity(intent);
                    ...
                    recyclerViewHistoryOut.setAdapter(adapter);
                }else {
                    //                    Toast.makeText(getActivity(), "Kosong", Toast.LENGTH_SHORT).show();
                    recyclerViewHistoryOut.setVisibility(View.GONE);
