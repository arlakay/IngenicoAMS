 ...
 * Use the {@link HistoryInFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HistoryInFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    @BindView(R.id.recycler_history_in)RecyclerView recyclerViewHistoryIn;
    ...
    public HistoryInFragment() {
        // Required empty public constructor
    }

    public static HistoryInFragment newInstance() {
        return new HistoryInFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewHistoryIn.setLayoutManager(linearLayoutManager);
        recyclerViewHistoryIn.setHasFixedSize(true);
    ...
    private void getHistoryStockIn() {

        ApiService apiService =
                RestApi.getClient().create(ApiService.class);

        Call<HistoryResponse> call = apiService.historyStockIn(staff_code);
        call.enqueue(new Callback<HistoryResponse>() {
            ...
            public void onResponse(Call<HistoryResponse>call, Response<HistoryResponse> response) {
                ...
                if (response.isSuccessful() && response.body().getStatus()) {
                    ...
                    mFirebaseAnalytics.logEvent("history_in", params);
...
//                            startActivity(intent);
                    ...
                    recyclerViewHistoryIn.setAdapter(adapter);
                }else {
                    //                    Toast.makeText(getActivity(), "Kosong", Toast.LENGTH_SHORT).show();
                    recyclerViewHistoryIn.setVisibility(View.GONE);
